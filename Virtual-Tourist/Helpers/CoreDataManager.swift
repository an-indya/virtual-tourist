...
class CoreDataManager: NSObject {
    ...
    func createVTContainer(completion: @escaping (NSPersistentContainer) -> ()) {
...
extension Managed where Self: NSManagedObject {
    static func delete (_ managedObjectContext: NSManagedObjectContext, where predicate: NSPredicate) {
